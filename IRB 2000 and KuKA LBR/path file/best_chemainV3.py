...
ax.plot(path_coordinates[:, 0], path_coordinates[:, 1], path_coordinates[:, 2], 'b')
ax.scatter(path_coordinates[:, 0], path_coordinates[:, 1], path_coordinates[:, 2], c='r', s=100)  # Start and end points
ax.scatter(start_pos[0], start_pos[1], start_pos[2], c='g', marker='o', s=200, label='Start')
ax.scatter(end_pos[0], end_pos[1], end_pos[2], c='y', marker='^', s=200, label='End')
ax.legend()
